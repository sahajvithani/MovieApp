...
//        movieViewModel = ViewModelProvider(this)[MovieViewModel::class.java]
        ...
        movieViewModel.fetchMovies(Constants.NOW_PLAYING, currentPage, Constants.API_KEY)
    ...
    private fun observeMovies() {
        movieViewModel.movieResponse.observe(viewLifecycleOwner) { response ->
            if (response != null) {
